...
checkpoint_callback = ModelCheckpoint(
    ...
    monitor="val_loss",
    mode="min",
    dirpath="./artefacts/lstm_mlp_input_l1_modified_v2_stft_aft_l1_v10",
    filename="lstm_mlp_input-{epoch:02d}-{val_loss:.2f}",
)

trainer = pl.Trainer(gradient_clip_val=0.3, callbacks=[StochasticWeightAveraging(swa_lrs=1e-2), checkpoint_callback], accelerator="gpu")
